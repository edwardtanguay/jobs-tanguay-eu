			...
			<div className="responsiveHeader">
				...
				<h3 className="show_computer">
					{searchText.trim() === '' ? (
						...
						<div className="infoMessage">Note that <strong>HTML</strong>, <strong>CSS</strong> and <strong>JavaScript</strong> are not listed on this site since they are assumed skills for all developer jobs.</div>
						</div>
					) : (
